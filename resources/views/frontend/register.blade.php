		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					{!! Form::open(['route' => 'auth.register','id'=>'payment-form','name'=>'register-form','class'=>'nobottommargin']) !!}
					<div class="col_two_third col_last">
						...
						<h4>4. Enter Your Payment Information</h4>
						<div class="columnbox">


								<div class="col_half">

									{!! Form::label('register-form-fname','First Name') !!}
									{!! Form::text('first_name',null,['id'=>'first-name','class'=>'form-control']) !!}

								</div>
								<div class="col_half col_last">
									{!! Form::label('register-form-lname','Last Name') !!}
								...
								<br>
								By clicking sign-up, I agree to the <a href="terms-of-use.html">terms of use</a> and <a href="privacy-policy.html">privacy policy</a><br>
